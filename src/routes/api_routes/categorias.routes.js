...
// crear una categoría
router.post("/categorias", categoriasControl.createCategoria);

// Editar una categoría por su id
router.put("/categorias/:id", categoriasControl.updateById);

// Borrar una categoría por su id
router.delete("/categorias/:id", categoriasControl.deleteById);
